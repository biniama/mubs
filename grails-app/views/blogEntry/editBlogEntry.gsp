            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="panel panel-default">
                        ...
                        <g:form url="[resource:blogEntryInstance, action:'updateBlogEntry']" method="PUT"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12 text-right">
                                    <g:actionSubmit name="updateBlogEntry" action="updateBlogEntry"
                                                    class="btn btn-default" value="${message(code: 'update.blog.entry.label', default: 'Update Blog Entry')}" />
                                </div>
                            </div>
                        </g:form>
                    </div>
